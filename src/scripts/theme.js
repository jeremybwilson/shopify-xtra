    ...
    var initThumbSlider = function(prodSlideshow) {
      ...
      if ( slider_type == 'bottom') {
        ...
        $slideshow.slick({
          arrows: true,
          infinite: false,
          nextArrow: '<button type="button" class="slick-next" aria-label="Previous" ><div class="bar-left"></div><div class="bar-right"></div></button>',
          prevArrow: '<button type="button" class="slick-prev" aria-label="Next" ><div class="bar-left"></div><div class="bar-right"></div></button>',
          slidesToShow: 5,
          slidesToScroll: 3,
